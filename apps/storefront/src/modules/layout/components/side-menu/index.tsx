      ...
      <div className="flex items-center h-full">
        <Popover className="h-full flex outline-none">
          <div className="flex h-full">
            ...
            >
              <div className="flex flex-col items-center gap-y-1">
                ...
                <span className="text-[8px] leading-none tracking-wide uppercase">Menu</span>
              </div>
            </PopoverButton>
          </div>
          ...
          >
            <PopoverPanel
              static
              className="flex flex-col fixed w-full pr-4 sm:pr-0 sm:w-1/3 2xl:w-1/4 sm:min-w-min h-[calc(100vh-1rem)] z-[200] inset-x-0 text-sm text-ui-fg-on-color m-2 backdrop-blur-2xl top-0"
            >
              <div
                data-testid="nav-menu-popup"
                className="flex flex-col h-full bg-[rgba(3,7,18,0.5)] rounded-rounded justify-center p-6 relative"
              >
                <div className="absolute top-6 right-6" id="xmark">
