...
export type ColorGroup = {
  ...
  danger: Maybe<Scalars['String']['output']>;
...
export type Content = {
  ...
  is_active: Scalars['Boolean']['output'];
  in_footer: Scalars['Boolean']['output'];
  created_at: Scalars['DateTime']['output'];
  updated_at: Scalars['DateTime']['output'];
  deleted_at: Maybe<Scalars['DateTime']['output']>;
};
...
export type BusinessInfo = {
  ...
  zalo_url: Maybe<Scalars['String']['output']>;
  ...
  metadata: Maybe<Scalars['JSON']['output']>;
  root_category_id: Maybe<Scalars['String']['output']>;
  created_at: Scalars['DateTime']['output'];
  updated_at: Scalars['DateTime']['output'];
  deleted_at: Maybe<Scalars['DateTime']['output']>;
};
...
export type ProductStat = {
  ...
  weekly_selling_amount: Scalars['Int']['output'];
  weekly_view_amount: Scalars['Int']['output'];
  monthly_selling_amount: Scalars['Int']['output'];
  monthly_view_amount: Scalars['Int']['output'];
  annual_selling_amount: Scalars['Int']['output'];
  annual_view_amount: Scalars['Int']['output'];
  total_sell_amount: Scalars['Int']['output'];
  total_view_amount: Scalars['Int']['output'];
  created_at: Scalars['DateTime']['output'];
  updated_at: Scalars['DateTime']['output'];
  deleted_at: Maybe<Scalars['DateTime']['output']>;
};

export type ProductStatHistory = {
  __typename?: 'ProductStatHistory';
  id: Scalars['ID']['output'];
  product_id: Scalars['String']['output'];
  reset_type: Scalars['String']['output'];
  selling_amount: Scalars['Int']['output'];
  view_amount: Scalars['Int']['output'];
...
export type ScheduledJob = {
  ...
  id: Scalars['ID']['output'];
  function_key: Scalars['String']['output'];
  label: Maybe<Scalars['String']['output']>;
  schedule_type: Scalars['String']['output'];
  cron_expression: Maybe<Scalars['String']['output']>;
  run_at: Maybe<Scalars['DateTime']['output']>;
...
export type ScheduledJobLog = {
  __typename?: 'ScheduledJobLog';
  id: Scalars['ID']['output'];
  job_id: Scalars['String']['output'];
  ran_at: Scalars['DateTime']['output'];
  status: Scalars['String']['output'];
...
declare module '@medusajs/framework/types' {
  interface RemoteQueryEntryPoints {
    ...
    business_infos: BusinessInfo
    product_stat: ProductStat
    product_stats: ProductStat
    product_stat_history: ProductStatHistory
    product_stat_histories: ProductStatHistory
    scheduled_job: ScheduledJob
    scheduled_jobs: ScheduledJob
    scheduled_job_log: ScheduledJobLog
    scheduled_job_logs: ScheduledJobLog
    ...
    product_brand: LinkProductProductBrandModuleBrand
  }
}