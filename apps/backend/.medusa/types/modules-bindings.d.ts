...
import type BrandModule from '../../src/modules/brand'
import type SystemColorModule from '../../src/modules/system-color'
import type ColorGroupModule from '../../src/modules/color-group'
...
declare module '@medusajs/framework/types' {
  interface ModuleImplementations {
    ...
    'brandModule': InstanceType<(typeof BrandModule)['service']>,
    'systemColorModule': InstanceType<(typeof SystemColorModule)['service']>,
